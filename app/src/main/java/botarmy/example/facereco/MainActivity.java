package botarmy.example.facereco;
        ...
        detector.process(image).addOnSuccessListener(new OnSuccessListener<List<Face>>() {
            ...
            public void onSuccess(@NonNull List<Face> faces) {
                ...
                if (faces.size() == 0) {
                    ...
                    bundle.putString(botarmy.example.facereco.FaceDetection.RESULT_TEXT,resultText);
                    DialogFragment resultDialog = new FaceResult();
                    resultDialog.setArguments(bundle);
                    resultDialog.setCancelable(false);
                    resultDialog.show(getSupportFragmentManager(), botarmy.example.facereco.FaceDetection.RESULT_DIALOG);
